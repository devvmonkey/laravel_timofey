...
@section('content')
    <main class="page">
        ...
        <section class="tournaments">
			<div class="container-fluid">
                <h2>Розыгрыши</h2>
                <p>Здесь мы публикуем все активные и прошедшие розыгрыши.</p>
                <div class="filtered">
                    <div class="filter">
                        <select>
                            ...
                            <option value="april">Все статусы</option>
                        </select>
                    </div>
                </div>
	...
	@foreach($datadr['draw'] as $page) 
					<div class="table-flex-line">
...
?>
						...
						<div class="table-flex-line-button">
