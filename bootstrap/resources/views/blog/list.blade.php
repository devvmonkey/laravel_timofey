...
@section('content')
  <div class="container">
    ...
    <div class="clearfix">
      <div class="pull-left">
        <div class="lead">Blog Posts</div>
      </div>
      <div class="pull-right">
        <a href="/blog/add" class="btn btn-success">Add new</a>
      </div>
    </div>
    ...
    <table class="table table-bordered table-hover table-striped">
      ...
      @foreach($blog as $page)
        <tr>
          <td>{{ $page->id }}</td>
          <td>
            <a href="/blog_edit/{{ $page->id }}">{{ $page->title }}</a>
          </td>
          <td>
          ...
          <td>
            <div class="input-group-btn">
              <a href="{{ route('blog_edit.edit', $page->id) }}" class="btn btn-primary">Edit</a>
              <a href="{{ route('blog_edit.delete', $page->id) }}" class="btn btn-danger"
                 onclick="return confirm('Are you sure to delete this blog post?');">
                Delete
              </a>
            </div>
          </td>
